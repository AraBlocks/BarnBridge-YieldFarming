...
contract YieldFarm {
    ...
    // pre-computed variable for optimization. total amount of ara tokens to be distributed on each epoch
    ...
    // constructor
    constructor(address araTokenAddress, address usdc, address susd, address dai, address stakeContract, address communityVault) public {
